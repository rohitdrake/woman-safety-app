...
document.getElementById("serious").onclick = () => getgeolocation('/seriousCrime');
document.getElementById("woman").onclick = () => getgeolocation('/womanCrime');
document.getElementById("business").onclick = () => getgeolocation('/businessCrime');
document.getElementById("nonserious").onclick = () => getgeolocation('/nonseriousCrime');
